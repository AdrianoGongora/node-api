...
var registerNewUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var userExist, passHash;
...
var loginUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var userExist, passwordHas, isDCorrect;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                passwordHas = userExist.password;
                return [4 /*yield*/, (0, bcrypt_handle_1.verified)(password, passwordHas)];
            case 2:
                isDCorrect = _c.sent();
                if (!isDCorrect)
                    return [2 /*return*/, "PASSWORD_INCORRECT"];
                return [2 /*return*/, (0, jwt_handle_1.generateToken)(userExist.email)];
        }
    });
}); };
