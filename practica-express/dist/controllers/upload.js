...
var getFile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, file, dataToRegister, reponse, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                dataToRegister = {
                    fileName: "".concat(file === null || file === void 0 ? void 0 : file.fieldname),
                    idUser: "".concat(user === null || user === void 0 ? void 0 : user.id),
                    path: "".concat(file === null || file === void 0 ? void 0 : file.path)
                };
                return [4 /*yield*/, (0, storage_service_1.registrarUpload)(dataToRegister)];
            case 1:
                reponse = _a.sent();
